 ...
 * on 07,May,2021
 */
public class HorizontalGridAdapter extends RecyclerView.Adapter<HorizontalGridAdapter.ViewHolder> {
    private List<String> listData;
    private AppUtils.AdapterClickListener listener;

    public HorizontalGridAdapter(List<String> listData, AppUtils.AdapterClickListener listener) {
